...
class AuthModal extends HTMLElement {
  constructor() {
    ...
    // Attach shadow DOM (encapsulated styles + markup)
    ...
    shadow.innerHTML = `
      ...
      <div id="authModal">
        <div class="modal-box">
          ...
          <p style="margin-top:16px; font-size:12px; color:#888;">Your data will not be shared publicly.</p>
        </div>
      </div>
    `;
  }
  ...
  connectedCallback() {
    ...
    btn.addEventListener("click", () => {
      if (window.tokenClient) {
        ...
        this.hide(); // hide modal after starting auth
      } else {
        console.error("⚠️ tokenClient is not initialized.");
      }
    });
  }
}
...
// Functions to show/hide modal from outside